                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                $selected_tags = isset($post['etiquetas']) ? explode(',', $post['etiquetas']) : [];
                                ...
                                <input type="hidden" name="etiquetas" id="etiquetas_hidden" value="<?php echo htmlspecialchars($post['etiquetas'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
