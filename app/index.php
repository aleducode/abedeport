        ...
        <div class="card  text-black navbar " style="color: rgb(173, 75, 19); border:1px solid black">
            <div class="card-body">
                ...
                <div class="text-center">
                    <h1 class="display-6 color animacion1">Iniciar Sesión</h1>
                </div>
                ...
                <form action="" method="post" enctype="application/x-www-form-urlencoded">
                    ...
                    <div class="row">
                        <button type="submit" class="btn w-100 text-white fw-bold mt-3 efecto-black" name="btnlogin"
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <a href="reg_users">
                                    <p class="color">Registrate</p>
                                </a>
                            </div>
                            <div class="col-sm-8">
                                <a href="forgotpass">
                                    <p class="color">¿Olvidaste la contraseña?</p>
                                </a>
                            </div>
                        </div>
                    </div>
