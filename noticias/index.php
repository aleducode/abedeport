					...
					<div class="header__primary-inner">
						...
						<nav class="main-nav">
							<ul class="main-nav__list">
								<li class="active"><a href="_esports_index.html">Inicio</a>
									<ul class="main-nav__sub">
										<li class="active"><a href="_esports_index.html">Portada Principal</a></li>
					...
					<div class="content col-lg-8">
						...
						<div class="main-news-banner main-news-banner--bg main-news-banner--img-left">
							<figure class="main-news-banner__img">
								<img src="assets/images/esports/samples/jugador-news-banner__img.png" alt="">
							</figure>
								...
								<div class="posts posts--simple-list posts--simple-list--xlg">
									<div class="posts__item posts__item--category-1">
										<div class="posts__inner">
											...
											<h6 class="posts__title"><a href="_esports_blog-post-2.html">Liga de Campeones: El delantero estrella recibirá una gran renovación</a></h6>
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-4  card">
									...
									<div class="posts__inner card__content">
										...
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">Nuevas modalidades deportivas llegan en abril</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-1 posts__item--category-4  card">
									...
									<div class="posts__inner card__content">
										...
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">Nuevo entrenador se une al equipo profesional</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-1  card">
									...
									<div class="posts__inner card__content">
										...
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">El equipo viaja a Madrid para la final</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
							...
							<div class="post-grid__item col-sm-6">
								<div class="posts__item posts__item--card posts__item--category-3  card">
									...
									<div class="posts__inner card__content">
										...
										<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">Nuevos equipamientos deportivos llegan en julio</a></h6>
									</div>
									<footer class="posts__footer card__footer">
										<div class="post-author">
											<figure class="post-author__avatar">
							...
							<div class="twitch-streams">
								...
								<div class="twitch-stream-wrapper">
									<a href="#" class="twitch-stream twitch-stream--featured twitch-stream--has-video card">
										...
										<div class="twitch-stream__body">
											...
											<h5 class="twitch-stream__title">Destroy Plays Fútbol Premier</h5>
								...
								<div class="twitch-stream-wrapper">
									<a href="#" class="twitch-stream   card">
										...
										<div class="twitch-stream__body">
											<h5 class="twitch-stream__title">Liga de Campeones: Ether Quest</h5>
								...
								<div class="widget-game-result__section">
									<div class="widget-game-result__section-inner">
										...
										<header class="widget-game-result__header widget-game-result__header--alt widget-game-result__header--alt-compact mb-4">
											<h3 class="widget-game-result__title">Fútbol Liga</h3>
											<time class="widget-game-result__date" datetime="2018-04-26">Friday, April 26th</time>
										</header>
						
										<header class="widget-game-result__header">
											<h3 class="widget-game-result__title">Liga Profesional - World Championship</h3>
										...
										<div class="widget-game-result__main">
											...
											<div class="widget-game-result__team widget-game-result__team--first">
												...
												<div class="widget-game-result__team-info">
													<h5 class="widget-game-result__team-name">Club Deportivo</h5>
											...
											<div class="widget-game-result__team widget-game-result__team--second">
												...
												<div class="widget-game-result__team-info">
													<h5 class="widget-game-result__team-name">L.A. Sporting</h5>
													<div class="widget-game-result__team-desc">United States</div>
												</div>
											</div>
											<!-- 2nd Team / End -->
										...
										<div class="game-result__mvp">
											<div class="game-result__mvp-player">
												...
												<div class="game-result__mvp-player-meta">
													...
													<span class="game-result__mvp-player-team">The Club Deportivo</span>
												</div>
											</div>
								...
								<ul class="alc-event-list list-unstyled">
									...
									<li class="alc-event-list__item alc-event-list-item alc-event-list-item--type-4">
										...
										<div class="alc-event-list-item__body">
											...
											<div class="alc-event-list-item__info">
												<h6 class="alc-event-list-item__title"><a href="_esports_event-overview-1b.html">Fútbol Premier Patch 5.6 Update Release</a></h6>
												<p class="alc-event-list-item__desc">Bug fixes and a new jugador!</p>
											</div>
										</div>
									</li>
								</ul>
											...
											<ul class="posts posts--simple-list">
												...
												<li class="posts__item posts__item--category-1 posts__item--category-3 ">
													...
													<div class="posts__inner">
														...
														<h6 class="posts__title posts__title--color-hover"><a href="_esports_blog-post-1.html">The Team defeated the L.A. Sporting 2-1 in the Liga Profesional...</a></h6>
